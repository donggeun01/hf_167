...
public class StoreDTO {
	...
	public String toString() {
		return "StoreDTO [name=" + name + ", category_code=" + category_code + ", tel=" + tel + ", location=" + location
				+ ", delivery_price=" + delivery_price + ", least_price=" + least_price + ", store_img=" + store_img
				+ ", info=" + info + ", condition=" + condition + ", condition_value=" + condition_value
